<template>
    <div class="crop-post-image">
        <div class="h-52 w-28 bg-gray-700 shadow-lg rounded-lg absolute bottom-16" v-show="cropItem">
            <ul class="h-52 grid">
                <li 
                    class="py-2 border-b px-3 flex items-center"
